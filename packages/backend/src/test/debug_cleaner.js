/**
 * @file debug_cleaner.js
 * @description 调试 text_cleaner 的每一步清理流程，逐步执行各清理函数，
 *   观察中间结果，定位 Emoji 和颜文字清理的问题
 * @module test
 * @author xiaomeng
 * @version 1.0.0
 * @date 2026-06-07
...
/** @constant {string} testInput - 包含 Emoji 的测试输入 */
const testInput = '今天很开心 😊 你呢？🎉';
